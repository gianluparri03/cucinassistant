...
class TestMenus(SubTest):
    ...
    def S01_get_menu(self):
        ...
        self.t.assertRaisesRegex(CAError, 'Menù non trovato', db.get_menu, self.giovanna, 'a')
        self.t.assertRaisesRegex(CAError, 'Menù non trovato', db.get_menu, self.giovanna, 7)
        self.t.assertRaisesRegex(CAError, 'Menù non trovato', db.get_menu, self.giovanna, 0)
    ...
    def S02_update_menu(self):
        ...
        self.t.assertRaisesRegex(CAError, 'Menù non valido', db.update_menu, self.francesco, 1, 'pippo')
