...
var english *Lang = &Lang{
	...
	Strings: map[String]string{
		...
		STR_INVALID_DATES:                       "Invalid dates",
		...
		String(database.ERR_DAY_NOT_MOVED):              "Cannot move this day",
		String(database.ERR_MEAL_NOT_FOUND):             "Meal not found",
